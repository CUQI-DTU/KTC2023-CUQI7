    ...
    for objectno in range (0,len(mat_files)):
        ...
        if np.sum(reconstruction==2) >0:
            ...
            while(FLAG10 == 1):
                ...
                q2 = 10
                phi1_new10, phi2_new10, F10, FLAG10 = level_set(phi10,phi20,q2,step_size,Uelref,Uel,vincl,solver,V1,idx,V02,z,D,idx2)
            ...
            while(FLAG5 == 1):
                ...
                q2 = 5
                phi1_new5, phi2_new5, F5, FLAG5 = level_set(phi10,phi20,q2,step_size,Uelref,Uel,vincl,solver,V1,idx,V02,z,D,idx2)
                step_size = 0.5*step_size
                stepsize_counter = stepsize_counter + 1
                if stepsize_counter == 5:
                    break
            ...
            while(FLAG == 1):
                ...
                phi1_new, phi2_new, F, FLAG = level_set(phi10,phi20,q2,step_size,Uelref,Uel,vincl,solver,V1,idx,V02,z,D,idx2)
                step_size = 0.5*step_size
                stepsize_counter = stepsize_counter + 1
                if stepsize_counter == 5:
                    break
...
def level_set(phi10,phi20,q2,step_size,Uelref,Uel,vincl,solver,V1,idx,V02,z,D,idx2):
